...
const drawBoard = () => {
  boxes.forEach((box, i) => { // if else create box border
    let styleString = '';
    if (i < 3) {
...
const boxClicked = (e) => { // box click event and show who was win 
...
const playerWon = () => { // won player how to win style show
...
const playerDraw = () => { // if any person not win that time game was draw
  let draw = 0;
